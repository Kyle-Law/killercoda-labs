...
# core-install.yaml, unlike the full install, does not bootstrap a
# "default" AppProject on its own -- every Application needs one to
# reference, so create it explicitly before the Application exists.
