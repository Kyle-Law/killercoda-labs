...
Same app as before — `siddharth67/solar-system`, no database, dead simple — but this time you write its manifests into a repo that exists only because you made it exist, in this session, in this cluster.
