...
- `gitops/` — Argo CD: sync/health, drift & self-heal, sync waves & hooks, Helm/Kustomize sources, history & rollback, App-of-Apps & ApplicationSet, the full UI on a multi-node cluster; plus standalone Argo Rollouts canary & blue-green
